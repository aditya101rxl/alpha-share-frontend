                ...
                <Paper className={classes.paper} elevation={3}>
                    ...
                    <form className={classes.form} onSubmit={handleSubmit}>
                        <Grid container spacing={1}>
                            <Grid item xs={12}>
                                <TextField name='username' label='User Name' type='text' autoComplete='off' required fullWidth onChange={handleChange} />
                            </Grid>
                            {isSignup && (
                                <>
                                    <Grid item xs={12} sm={6}>
                                        <TextField name='firstname' label='First Name' type='text' autoComplete='off' required fullWidth onChange={handleChange} />
                                    </Grid>
                                    <Grid item xs={12} sm={6}>
                                        <TextField name='lastname' label='Last Name' type='text' autoComplete='off' required fullWidth onChange={handleChange} />
                                    </Grid>
                                    <Grid item xs={12}>
                                        <TextField disabled={isEmailVerified} name='email' label='Email Address' type='email' autoComplete='off' required fullWidth onChange={handleChange} />
                                    </Grid>
                                </>
                            )}
                            <Grid item xs={12}>
